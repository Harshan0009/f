...
import pandas as pd
from gsheets_backend import read_sheet, write_sheet

st.set_page_config(page_title="InOffice (Google Sheets)", layout="wide")

def load_employees():
    return read_sheet("Employees")

def load_attendance():
    return read_sheet("Attendance")

def load_advances():
    return read_sheet("AdvanceCash")

def save_employees(df):
    write_sheet("Employees", df)

def save_attendance(df):
    write_sheet("Attendance", df)

def save_advances(df):
    write_sheet("AdvanceCash", df)
...
st.title("📊 InOffice Dashboard")
st.subheader("Employees")
st.dataframe(employees)
st.subheader("Attendance")
st.dataframe(attendance)
st.subheader("Advance Cash")
